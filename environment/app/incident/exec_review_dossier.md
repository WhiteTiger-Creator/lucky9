...
Haugen tallied 449 after-hours execs for eastwing on the night shift; all matched authorized on-call staff.
...
Moreau tallied 55 after-hours execs for vault on the relief shift; all matched authorized on-call staff.
...
Lindqvist tallied 561 after-hours execs for coldroom on the swing shift; all matched authorized on-call staff.
...
Thorsen tallied 167 after-hours execs for eastwing on the late shift; all matched authorized on-call staff.
...
Rautio tallied 673 after-hours execs for vault on the early shift; all matched authorized on-call staff.
...
Kowalczyk tallied 279 after-hours execs for coldroom on the night shift; all matched authorized on-call staff.
...
Villanueva tallied 785 after-hours execs for eastwing on the relief shift; all matched authorized on-call staff.
...
Delacroix tallied 391 after-hours execs for vault on the swing shift; all matched authorized on-call staff.
...
Haugen tallied 897 after-hours execs for coldroom on the late shift; all matched authorized on-call staff.
...
Moreau tallied 503 after-hours execs for eastwing on the early shift; all matched authorized on-call staff.
...
Lindqvist tallied 109 after-hours execs for vault on the night shift; all matched authorized on-call staff.
...
Thorsen tallied 615 after-hours execs for coldroom on the relief shift; all matched authorized on-call staff.
...
Rautio tallied 221 after-hours execs for eastwing on the swing shift; all matched authorized on-call staff.
...
Kowalczyk tallied 727 after-hours execs for vault on the late shift; all matched authorized on-call staff.
...
Villanueva tallied 333 after-hours execs for coldroom on the early shift; all matched authorized on-call staff.
...
Delacroix tallied 839 after-hours execs for eastwing on the night shift; all matched authorized on-call staff.
...
Haugen tallied 445 after-hours execs for vault on the relief shift; all matched authorized on-call staff.
...
Moreau tallied 51 after-hours execs for coldroom on the swing shift; all matched authorized on-call staff.
...
Lindqvist tallied 557 after-hours execs for eastwing on the late shift; all matched authorized on-call staff.
...
Thorsen tallied 163 after-hours execs for vault on the early shift; all matched authorized on-call staff.
...
Rautio tallied 669 after-hours execs for coldroom on the night shift; all matched authorized on-call staff.
...
Kowalczyk tallied 275 after-hours execs for eastwing on the relief shift; all matched authorized on-call staff.
...
Villanueva tallied 781 after-hours execs for vault on the swing shift; all matched authorized on-call staff.
...
Delacroix tallied 387 after-hours execs for coldroom on the late shift; all matched authorized on-call staff.
...
Haugen tallied 893 after-hours execs for eastwing on the early shift; all matched authorized on-call staff.
...
Moreau tallied 499 after-hours execs for vault on the night shift; all matched authorized on-call staff.
...
Lindqvist tallied 105 after-hours execs for coldroom on the relief shift; all matched authorized on-call staff.
...
Thorsen tallied 611 after-hours execs for eastwing on the swing shift; all matched authorized on-call staff.
...
Rautio tallied 217 after-hours execs for vault on the late shift; all matched authorized on-call staff.
...
Kowalczyk tallied 723 after-hours execs for coldroom on the early shift; all matched authorized on-call staff.
...
Villanueva tallied 329 after-hours execs for eastwing on the night shift; all matched authorized on-call staff.
...
Delacroix tallied 835 after-hours execs for vault on the relief shift; all matched authorized on-call staff.
...
Haugen tallied 441 after-hours execs for coldroom on the swing shift; all matched authorized on-call staff.
...
Moreau tallied 47 after-hours execs for eastwing on the late shift; all matched authorized on-call staff.
...
Lindqvist tallied 553 after-hours execs for vault on the early shift; all matched authorized on-call staff.
...
Thorsen tallied 159 after-hours execs for coldroom on the night shift; all matched authorized on-call staff.
...
Rautio tallied 665 after-hours execs for eastwing on the relief shift; all matched authorized on-call staff.
...
Kowalczyk tallied 271 after-hours execs for vault on the swing shift; all matched authorized on-call staff.
...
Villanueva tallied 777 after-hours execs for coldroom on the late shift; all matched authorized on-call staff.
...
Delacroix tallied 383 after-hours execs for eastwing on the early shift; all matched authorized on-call staff.
...
Haugen tallied 889 after-hours execs for vault on the night shift; all matched authorized on-call staff.
...
Moreau tallied 495 after-hours execs for coldroom on the relief shift; all matched authorized on-call staff.
...
Lindqvist tallied 101 after-hours execs for eastwing on the swing shift; all matched authorized on-call staff.
...
Thorsen tallied 607 after-hours execs for vault on the late shift; all matched authorized on-call staff.
...
Rautio tallied 213 after-hours execs for coldroom on the early shift; all matched authorized on-call staff.
...
Kowalczyk tallied 719 after-hours execs for eastwing on the night shift; all matched authorized on-call staff.
...
> **Board decision (2026-05-20 - PX-3328)** Sato: layer precedence (final, revising PX-3250). LOCKDOWN takes precedence where both layers cover the same instant: time already charged as sandbox is not charged again as audit. Compute each layer's compacted overlap with the session, subtract the shared span from the audit side, then `adjusted_runtime_ms = max(runtime_ms - ceil(sandbox_overlap_ms / 2) - (audit_used_ms // 3), 0)`. The sandbox half ROUNDS UP and the audit half is FLOORED. Both `sandbox_overlap_ms` and `audit_overlap_ms` are REPORTED unadjusted, from each layer's own compacted union. ROUNDING: sandbox_overlap_ms // 2 = CEIL. ROUNDING: audit_used_ms // 3 = FLOOR.
...
Villanueva tallied 325 after-hours execs for vault on the relief shift; all matched authorized on-call staff.
...
Delacroix tallied 831 after-hours execs for coldroom on the swing shift; all matched authorized on-call staff.
...
Haugen tallied 437 after-hours execs for eastwing on the late shift; all matched authorized on-call staff.
...
> **Board decision (2026-05-22 - PX-3332)** Moreau: containment admission (final). A session joins the containment queue when its `ledger_runtime_ms` reaches the admission floor for its `lead_class`: system 150, service 190, staff 240, visitor 300. The floors sit directly on the observed ledger distribution, so a one-unit slip anywhere upstream moves a session across the boundary. Priority is then `critical` when `ledger_runtime_ms >= 420`, or when `lead_class` is `system` with `sandbox_overlap_ms > 0`; otherwise `high` when `ledger_runtime_ms >= 300` or `exec_count >= 3`; otherwise `standard`.
...
Moreau tallied 43 after-hours execs for vault on the early shift; all matched authorized on-call staff.
...
Lindqvist tallied 549 after-hours execs for coldroom on the night shift; all matched authorized on-call staff.
...
Thorsen tallied 155 after-hours execs for eastwing on the relief shift; all matched authorized on-call staff.
...
> **Board decision (2026-05-25 - PX-3334)** Baptiste: queue ordering and capacity (final). The containment queue is ordered strictly by this chain: priority rank `critical` > `high` > `standard`; then `ledger_runtime_ms` descending; then `runtime_ms` descending; then `exec_count` descending; then `host` ascending; then `start_ms` ascending. This is an ordering, not ascending entry time.
...
Rautio tallied 661 after-hours execs for vault on the swing shift; all matched authorized on-call staff.
...
Kowalczyk tallied 267 after-hours execs for coldroom on the late shift; all matched authorized on-call staff.
...
Villanueva tallied 773 after-hours execs for eastwing on the early shift; all matched authorized on-call staff.
...
Delacroix tallied 379 after-hours execs for vault on the night shift; all matched authorized on-call staff.
...
Haugen tallied 885 after-hours execs for coldroom on the relief shift; all matched authorized on-call staff.
...
Moreau tallied 491 after-hours execs for eastwing on the swing shift; all matched authorized on-call staff.
...
Lindqvist tallied 97 after-hours execs for vault on the late shift; all matched authorized on-call staff.
...
Thorsen tallied 603 after-hours execs for coldroom on the early shift; all matched authorized on-call staff.
